...
from georegistry.views import users
from georegistry.libraries import sms
from georegistry.libraries.tools import get_token
from georegistry.models import db, User, User_, SMSAddress
from georegistry.tests import TestTemplate, ReplaceableDict, settings
