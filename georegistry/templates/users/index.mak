...
<%def name='root()'>
<link rel=stylesheet href="${request.static_url('georegistry:static/dataTables/style.css')}">
<script src="${request.static_url('georegistry:static/dataTables/jquery.dataTables.min.js')}"></script>
<script src="${request.static_url('georegistry:static/dataTables/jquery.dataTables.titleString.min.js')}"></script>
</%def>
