...
from georegistry.libraries import tools
from georegistry.models import initialize_sql
from georegistry.views import users, pages
...
def main(global_config, **settings):
    ...
    settings.update({ 
        ...
        'mako.directories': 'georegistry:templates',
    ...
    config = Configurator(
        ...
        root_factory='georegistry.RootFactory')
    ...
    config.add_static_view('static', 'georegistry:static')
...
def load_settings(configurationPath, basePath):
    ...
    settings = {}
    for key, value in configParser.items('app:georegistry'):
        if 'use' == key:
